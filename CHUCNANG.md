...
### 4.2.6 Thêm module vào khóa học
| STT | Chức năng | Mô tả chi tiết | API Endpoint | Quyền truy cập |
|-----|-----------|----------------|--------------|----------------|
| 4.2.6 | **Thêm module vào khóa học** | Admin thêm một module mới vào một khóa học đã có. Cần cung cấp thông tin chi tiết về module như tiêu đề, mô tả, thứ tự, độ khó, và các mục tiêu học tập. | `POST /api/v1/admin/courses/{course_id}/modules` | Admin |

### 4.2.7 Thêm bài học vào module
| STT | Chức năng | Mô tả chi tiết | API Endpoint | Quyền truy cập |
|-----|-----------|----------------|--------------|----------------|
| 4.2.7 | **Thêm bài học vào module** | Admin thêm một bài học mới vào một module đã có trong một khóa học. Cần cung cấp thông tin chi tiết về bài học như tiêu đề, mô tả, nội dung, và loại nội dung. | `POST /api/v1/admin/courses/{course_id}/modules/{module_id}/lessons` | Admin |
