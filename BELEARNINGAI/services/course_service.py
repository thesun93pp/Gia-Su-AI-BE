...
from schemas.admin import AdminLessonCreate
...
async def add_module_to_course(
    ...
    Args:
        ...
        order: Thứ tự module
        difficulty: Độ khó
        estimated_hours: Số giờ học ước tính
        learning_outcomes: Mục tiêu học tập
        prerequisites: Các module tiên quyết
        resource: Tài nguyên
    ...
    module_doc = Module(
        id=new_module.id, # Use the same ID
        course_id=course_id,
        title=title,
        description=description,
        order=order,
        ...
        estimated_hours=estimated_hours,
        learning_outcomes=learning_outcomes,
        total_lessons=len(new_module.lessons),
        total_duration_minutes=new_module.total_duration_minutes
    )
...
>>>>>>> c90885cd03d5078539c60bc993e4102a3dfac0d2
    """
...
>>>>>>> c90885cd03d5078539c60bc993e4102a3dfac0d2
    ...
    lesson_doc_data = {
        ...
        'resources': [r.dict() for r in lesson_data.resource] if lesson_data.resource else [],
        'learning_objectives': lesson_data.learning_objectives,
        'simulation_html': lesson_data.simulation_html,
...
<<<<<<< HEAD
            module_data.pop("lessons", None) # Remove lesson from module_data to avoid validation error
=======
